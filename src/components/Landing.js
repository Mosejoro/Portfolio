...
import pfp from "./logo-color.png";
import mainImage from "./logo-grayscale.png";
...
export default function Landing(props) {
  const [menuStyle, setMenuStyle] = useState({
    ...
    background:
      "radial-gradient(circle, rgba(120,120,120,1) 44%, rgba(64,64,64,1) 100%)",
  });
  ...
  return (
    <>
      <div className="menu-container" style={menuStyle}>
        <h1 onClick={hideMenu}>
          <a href="#landinglinker">Home</a>
        </h1>
        <h1 onClick={hideMenu}>
          <a href="#workslinker">Works</a>
        </h1>
        <h1 onClick={hideMenu}>
          <a href="#aboutlinker">About Me</a>
        </h1>
        <h1 onClick={hideMenu}>
          <a href="#contactlinker">Contact</a>
        </h1>
      ...
      <div className="landing-container" id="landinglinker" ref={landingRef}>
        <div className="navbar-container">
          ...
          <div className="navbar-fixed">
            <div className="navbar-main">
              <h3>
                <a href="#aboutlinker" className="about-link">
                  About
                </a>
              </h3>
              <h3>
                <a href="#workslinker" className="works-link">
                  Works
                </a>
              </h3>
            </div>
        ...
        <div className="main-landing-container">
          <div className="socials-sidebar">
            {/* <div className="socials-button linkedin">
              <a href="https://linkedin.com/in/piyushmaan">
                <img src={linkedin} alt="LinkedIn"></img>
              </a>
            </div>
            <div className="socials-button github">
              <a href="https://github.com/psmaan">
                <img src={github} alt="GitHub"></img>
              </a>
            </div>
            <div className="socials-button instagram">
              <a href="https://www.instagram.com/piyuxhmaan">
                <img src={instagram} alt="Instagram"></img>
              </a>
            </div>
            <div className="socials-button twitter">
              <a href="https://twitter.com/heyxpiyush">
          ...
          <div className="main-landing">
            <div className="landing-headers">
              ...
              <h1>Transforming Ideas into Seeamless Interfaces</h1>
              <button>
                <a href="#contactlinker">Get In Touch</a>
              </button>
            </div>
